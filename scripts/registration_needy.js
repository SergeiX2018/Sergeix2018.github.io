...
button.addEventListener('click', function(e) {
    e.preventDefault()
     document.location.href = "office_needy.html";
    if(load_imgInsert.firstChild){
    ...
    //    }
       ...
       if (localStorage.getItem('man'))
        ...
        localStorage.manArrayOne = JSON.stringify(manArrayOne);
        manArrayOne = JSON.parse(localStorage.manArrayOne);
        
       
   
        localStorage.setItem('storedUsersOne', JSON.stringify(usersOne));
